...
function printModelsConfigStatus(): void {
  ...
  if (!userYamlExists && bundledDefault) {
    console.log(`  bundled default: ${bundledDefault}`);
    console.log('  Tip: create user yaml to override models.default or define aliases.');
  }
